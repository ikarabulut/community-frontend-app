        ...
        <div class="banner-content single-page text-center">
            <div class="banner-border">
                <div class="banner-info">
                    <h1>About</h1>
                    <p>Aliquam pellentesque nunc enim</p>
                </div><!-- / banner-info -->
            </div><!-- / banner-border -->
        </div><!-- / banner-content -->
    </div>
...
<div id="page-content" class="container">
    <div class="section-w-image">
        <div class="row">
            <div class="col-sm-7 about-img"><p></p></div>
            <div class="col-sm-5 col-sm-offset-7 about-description">
                <h4>ABOUT THE SHOP</h4>
                <p>Quisque nec mi urna. Nam nec enim id erat bibendum tincidunt. Morbi maximus neque sed ex aliquet, in lobortis mi condimentum. Vestibulum laoreet placerat ex id viverra. Ut auctor odio magna, in vulputate lorem tempus sed. Quisque bibendum molestie lacus. Phasellus quis commodo ex, id volutpat purus. Quisque ac ante a tellus auctor molestie in ac sem. Mauris non ultricies ligula. Aliquam malesuada finibus magna a egestas.</p>
                <p>Vivamus eu lacus eros. Integer ornare scelerisque sapien ac blandit. Sed blandit diam vel tincidunt placerat. Sed a eleifend dui. Cras gravida dapibus sapien et rhoncus. Nulla facilisi. Donec vitae pharetra sapien.</p>
                <p>Nullam auctor ac erat in semper. Aliquam erat volutpat. Nullam malesuada nunc vel lectus ultrices.</p>
    ...
    <section id="team">
        <div class="container">
            <h2 class="text-center space-top-2x">THE TEAM</h2>
            <div class="row">
                <!-- team-block -->
                <div class="col-sm-4">
