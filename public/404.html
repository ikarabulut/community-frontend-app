            ...
            <div class="navbar-collapse collapse text-center">
                <ul class="nav navbar-nav">
                    ...
                    <ul class="dropdown-menu animated zoomIn fast">
                        ...
                        <li class="active"><a href="404.html"><span>404 PAGE</span></a></li>
...
<div id="page-content" class="container">
    <div class="pnf-content text-center">
        <h2>WHOOOPS... WE'RE SO SORRY!</h2>
        <p class="lead">The requested page can't be found!</p>
        <p><a href="index.html" class="btn btn-lg btn-primary-filled btn-rounded"><i class="fa fa-long-arrow-left"></i><span>Back to HomePage</span></a></p>
        <h6>OR</h6>
        <p><a href="shop.html" class="btn btn-lg btn-default-filled btn-rounded"><i class="fa fa-shopping-cart"></i><span>Back to Shop</span></a></p>
    </div>
</div><!-- / container -->
