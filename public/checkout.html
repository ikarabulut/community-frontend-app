    ...
    <div class="container">
        <div class="row checkout-screen">
            <div class="col-sm-8 checkout-form">
                ...
                <p class="space-left have-account space-bottom">Already have an account? <a href="login-register.html"><span>Login</span></a></p>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="address-line" placeholder="*ADDRESS" required>
                    </div>
                </div><!-- / row -->
                ...
                <div class="checkout-form-footer space-left space-right">
                    ...
                    <a href="" class="btn btn-primary-filled btn-rounded"><i class="lnr lnr-cart"></i><span>Checkout</span></a>
                </div><!-- / checkout-form-footer -->

            </div><!-- / checkout-form -->

            <div class="col-sm-4 checkout-total">
                <h4>CART TOTAL: <span>$147</span></h4>
                ...
                <div class="cart-total-footer">
                    ...
                    <a href="shop-right.html" class="btn btn-primary-filled btn-rounded"><i class="lnr lnr-store"></i><span>Back to Shop</span></a>
