...
<div id="page-content" class="container">
    <div class="row">
        ...
        <div class="col-sm-4 contact-info text-center space-bottom">
            ...
            <h5>PHONE</h5>
            <p>Sales: <a href="tel:+0123456789">+0123 456 789</a></p>
        ...
        <div class="col-sm-4 contact-info text-center space-bottom">
            ...
            <h5>EMAIL</h5>
            <p>Sales: <a href="mailto:sales@yoursite.com">sales@yoursite.com</a></p>
            <p>Support: <a href="support:hello@yoursite.com">support@yoursite.com</a></p>
        </div><!-- / contact-info -->
